...
for sample in dataSamples:
    dataPlotters.append(TreePlotter(sample+'.root','tree'))
...
Stack.drawStack('llnunu_mt', cuts, str(lumi*1000), 80, 0.0, 2400.0, titlex = "M_{T}", units = "GeV",output=tag+'out_mt_stack.eps',separateSignal=sepSig)
Stack.drawStack('llnunu_l2_pt', cuts, str(lumi*1000), 50, 0.0, 1500.0, titlex = "MET", units = "GeV",output=tag+'out_met_stack.eps',separateSignal=sepSig)
Stack.drawStack('llnunu_l1_pt', cuts, str(lumi*1000), 50, 0.0, 1500.0, titlex = "P_{T}(Z)", units = "GeV",output=tag+'out_zpt_stack.eps',separateSignal=sepSig)
